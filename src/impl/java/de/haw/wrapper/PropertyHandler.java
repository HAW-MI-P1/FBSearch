...
public class PropertyHandler {
	...
	/*
	 * Create properties file with login credentials so they don't accidentally
	 * get pushed somewhere. Only needs to be called once.
	 */
	public void setInitialProperties(String appID, String appSecret,
